                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-xl-6">
                                        <div
                                            ...
                                            <div class="product-img list-img-width">
                                                <a href="#">
                                                    <img src="{{asset("assets/img/product/fashion-colorful/1.jpg")}}"
                                                         alt="">
                                                </a>
                                                <span>hot</span>
                                            ...
                                            <div class="product-content-list">
                                                <div class="product-list-info">
                                                    ...
                                                    <span>$150.00</span>
                                                    <p>Lorem ipsum dolor sit amet, mana consectetur adipisicing elit,
                                                        sed do eiusmod tempor labore. </p>
                                                </div>
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div
                                            ...
                                            <div class="product-img list-img-width">
                                                <a href="#">
                                                    <img src="{{asset("assets/img/product/fashion-colorful/2.jpg")}}"
                                                         alt="">
                                                </a>
                                                <div class="product-action-list-style">
                                                    <a class="animate-right" title="Quick View" data-toggle="modal"
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div
                                            ...
                                            <div class="product-img list-img-width">
                                                <a href="#">
                                                    <img src="{{asset("assets/img/product/fashion-colorful/3.jpg")}}"
                                                         alt="">
                                                </a>
                                                <div class="product-action-list-style">
                                                    <a class="animate-right" title="Quick View" data-toggle="modal"
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div
                                            ...
                                            <div class="product-img list-img-width">
                                                <a href="#">
                                                    <img src="{{asset("assets/img/product/fashion-colorful/4.jpg")}}"
                                                         alt="">
                                                </a>
                                                <span>new</span>
                                                <div class="product-action-list-style">
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div
                                            ...
                                            <div class="product-img list-img-width">
                                                <a href="#">
                                                    <img src="{{asset("assets/img/product/fashion-colorful/5.jpg")}}"
                                                         alt="">
                                                </a>
                                                <span>hot</span>
                                                <div class="product-action-list-style">
...
<footer class="footer-area">
    <div class="footer-top-area bg-img pt-105 pb-65"
         style="background-image: url({{asset("assets/img/bg/1.jpg")}}) data-overlay=" 9
    ">
    <div class="container">
        <div class="row">
